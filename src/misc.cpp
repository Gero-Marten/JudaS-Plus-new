...
/// engine_info() returns the full name of the current Judas version. This
/// will be either "Judas <Tag> DD-MM-YY" (where DD-MM-YY is the date when
/// the program was compiled) or "Judas <Version>", depending on whether
/// Version is empty.
