...
void update_weights(int phase) {
    ...
    switch (phase) {
        ...
        case 0:  // Opening
            StrategyMaterialWeight = 20;  // Higher weight for material
            StrategyPositionalWeight = 10;  // Lower weight for position
            break;
        case 1:  // Middlegame
            StrategyMaterialWeight = 15;  // Balanced weight
            StrategyPositionalWeight = 15;
            break;
        case 2:  // Endgame
            StrategyMaterialWeight = 10;  // Lower weight for material
            StrategyPositionalWeight = 20;  // Higher weight for position
            break;
    }
}
